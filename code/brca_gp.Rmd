...
Create Cancer Gene Objective Function
```{r}
...
load("/drive-pool/data/peter_data/genetic_programming/code/brca/lexicase_breast_multi.run_030724.rda")
load("/drive-pool/data/peter_data/genetic_programming/code/brca/progressive_ctrl_multi.run_030824")
