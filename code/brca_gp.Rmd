...
## Objective function
obj.fun <- c("marker.gene", "magma", "hi.mut", "ppi", "marker.ppi", "inter.ppi", "intra.ppi", "lncrna.ppi", "promoter") #, "cevm", , "multi.ppi", "findmarkers", "cevm", "go.cc.ppi" #, "marker.atac", "common.atac"
...
date()
save(multi.gp, file = "/drive-pool/data/peter_data/genetic_programming/code/brca/multi.run_110623.rda")
...
gp.plotdata$method <- factor(gp.plotdata$method, levels = c("marker.gene", "magma", "cancer.gene", "ppi", "marker.ppi", "inter.ppi", "intra.ppi", "lncrna", "promoter", "fitness")) ## "marker.atac", "common.atac"
