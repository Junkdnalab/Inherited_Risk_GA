...
gwas_gp_no_omics <- function(init.proposal, generations, obj.fun, khan.method, selection.method, proposal.size, parent.size, n.cores) {
  ## Store result for fitness function
  fitness.res.list <- list() 
  ## Store initial proposal as df
  df <- init.proposal
...
##############################
## NO OMICS GA MODEL SCALED ##
##############################

gwas_gp_no_omics_scaled <- function(init.proposal, generations, obj.fun, khan.method, selection.method, proposal.size, parent.size, n.cores) {
  ## Store result for fitness function
  fitness.res.list <- list() 
  ## Store initial proposal as df
  df <- init.proposal
...
get.scale.hit <- function(data, gen, n_loci, n_of) {
...
###########################
## calc fitness no omics ##

calc_fitness_no_omics <- function(df, obj.fun, n.cores, method) {
  ## Storing results from obj fun for fitness function
  obj.fun.res <- list()
...
} ## End of calc fitness score


#################################
## Get objective function hits ##
## This is hardcoded... so it needs to be updated everytime an OF changes ## last changed 04/23/24
