...
## Load 1 sample
load("/drive-pool/data/peter_data/repo/Inherited_Risk_GA/result/progressive_breast_run_1_ppithres0_110424.rda")
## Load colors 
...
p1 <- ggplot(data = individual.fitness.gen, aes(x = gen, y = fitness)) +
  ...
  annotate(geom = "text", x = 112-50, y = 0.43, label = paste0("Gen=112"), color = "red", size = 3, family = "Arial")
```
...
p2 <- ggplot(data = perc.change.df, aes(x = gen, y = perc.change)) +
  ...
  geom_vline(xintercept = 112, linetype = "dashed", colour = "red") +
  theme(panel.grid = element_blank(),
        axis.line = element_line(colour = "black"))
```
...
map.of <- data.frame(of = c("marker.gene", "magma", "cancer.gene", "ppi", "marker.ppi", "inter.ppi",
                            "intra.ppi", "lncrna", "promoter", "marker.atac", "common.atac", "htftarget", "mb.remap"),
                     new.of = c("isMarkerGene", "isMAGMAgene", "isCancerGene", "isPPI", "isMarkerPPI", "isInterPPI",
                                "isIntraPPI", "isLPI", "isPromoter", "isMarkerATAC", "isCommonATAC", "isTFtarget", "isMBremap"))
...
# combined_plot
ggsave("/drive-pool/data/peter_data/repo/Inherited_Risk_GA/figures/figure_2.png", width = 170, height = 170,
       units = "mm", dpi = 300)
```
...
combined_plot1 <- p7 + p8 + p5 + p6 + plot_spacer() + plot_layout(design=layout, guides = "collect") + plot_annotation(tag_levels = "A") &
  theme(legend.position = 'bottom',
        ...
        text = element_text(family = "Arial")) 
# combined_plot
ggsave("/drive-pool/data/peter_data/repo/Inherited_Risk_GA/figures/figure_3.png", width = 170, height = 170,
       units = "mm", dpi = 300)
```
